...
export const CREATE_QUIZ_FAIL = 'CREATE_QUIZ_SUCCESS';
...
export const GET_QUIZ_MEETING_LIST_START = 'GET_QUIZ_MEETING_LIST_START';
export const GET_QUIZ_MEETING_LIST_SUCCESS = 'GET_QUIZ_MEETING_LIST_SUCCESS';
export const GET_QUIZ_MEETING_LIST_FAIL = 'GET_QUIZ_MEETING_LIST_FAIL';

export const GET_QUIZ_DETAIL_START = 'GET_QUIZ_DETAIL_START'; 
export const GET_QUIZ_DETAIL_SUCCESS = 'GET_QUIZ_DETAIL_SUCCESS';
export const GET_QUIZ_DETAIL_FAIL = 'GET_QUIZ_DETAIL_FAIL';